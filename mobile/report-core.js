...
(function (root) {
  ...
  /* ONE FONT, THE SAME ON EVERY DEVICE.

     The report used to set `system-ui`, which is San Francisco on an iPhone,
     Roboto on Android and Segoe UI on the office PC. Different glyph widths
     mean different line breaks, a different `fitPage` outcome and, on a long
     report, a different PAGE COUNT for the same inspection depending on which
     machine made it -- for a document senior management read on paper and
     compare between sites. So the report carries its own: CM Sans, a subset
     of Liberation Sans (metric-compatible with Arial, Cyrillic in full),
     13.8 kB a weight, embedded here as data URIs rather than as files because
     this stylesheet is injected into two pages in two directories and a
     relative URL would resolve against the wrong one on the office page.
     Licence and the subsetting command: docs/fonts/. */
  CMR.FONT_CSS = `
@font-face{font-family:"CM Sans";font-style:normal;font-weight:400;font-display:block;
  src:url(data:font/woff2;base64,) format("woff2");}
@font-face{font-family:"CM Sans";font-style:normal;font-weight:700;font-display:block;
  src:url(data:font/woff2;base64,) format("woff2");}
`;
  /* The stack a report sets. Arial and Helvetica before the platform default,
     because they are the faces CM Sans is metric-compatible with: where the
...
#rptRoot .h1 .alti{font-size:.5em;font-weight:600;opacity:.82;margin-left:3px;}
...
/* Printed, often in grey, so state is carried by the fill AND the outline
   ...
   colour in it at all. */
#rptRoot .bm-dot{fill:#fff;stroke:#5b6670;stroke-width:1.2;}
...
#rptRoot .bm-p.na .bm-dot{fill:#fff;stroke:#5b6670;stroke-dasharray:2 2;}
...
#rptRoot .bm-val{font:700 11px/1 "CM Sans",Arial,Helvetica,system-ui,-apple-system,"Segoe UI",Roboto,sans-serif;
...
#rptRoot .um-side{font-weight:700;font-size:17px;line-height:1;font-family:inherit;fill:#5b6670;letter-spacing:.04em;}
...
/* NAMED "repno", NEVER "rnum" — the dashboard's OWN unrelated chrome
   (the Report Builder wizard's numbered step circles, dashboard/index.html)
   already owns a bare ".rnum" that sets background/color/border-radius/
   height/display/flex for a 26px round badge. This rule only ever reset
   font-weight/letter-spacing/padding-left, so every property it left alone
   fell through to that unrelated rule by class-name collision alone: the
   report's own reference number rendered as a solid copper PILL with white
   text on the dashboard (border-radius:50% on a wide short box is a
   stadium shape, not a circle) while the identical document, generated by
   report-core.js and opened on the phone — which has no such class at all —
   showed the same text in plain grey. One engine, one document, two
   unrelated-looking headers, because of a class name a wizard step counter
   also happened to use. Read off EX021's own "report on this machine" PDF
   and reported as "the header is different" from the single-round report,
   which never used this class and so was never exposed to it. */
#rptRoot .mast .rno .repno{font-weight:700;letter-spacing:.06em;padding-left:2px;}
...
#rptRoot .mast .m1 .alti{font-size:.58em;font-weight:600;opacity:.82;margin-left:3px;}
...
#rptRoot .cel .ph{display:block;width:auto;max-width:100%;height:auto;max-height:330px;margin:0 auto;background:#fff;}
...
#rptRoot .alt{display:block;font-weight:400;font-size:.94em;line-height:1.25;
  letter-spacing:.02em;text-transform:none;color:#5b6670;}
#rptRoot .altl{display:block;font-weight:inherit;font-size:.95em;line-height:1.35;
  color:inherit;opacity:.78;margin-top:2px;}
#rptRoot .verdict .altl,#rptRoot .allok .altl{opacity:.85;}
...
#rptRoot .alti{color:#5b6670;font-weight:400;margin-left:3px;}
...
#rptRoot .ckey .n{flex:0 0 auto;min-width:15px;height:15px;border-radius:8px;background:#12161a;
  color:#fff;font-size:9.5px;font-weight:800;text-align:center;line-height:15px;
  font-variant-numeric:tabular-nums;}
#rptRoot .ckey .t{color:#2b333a;}
#rptRoot .ckey .t span{display:block;color:#5b6670;}
...
#rptRoot .ohd .oalt{color:#5b6670;margin-left:4px;}
...
#rptRoot .board.mini .cel dt{font-size:9.5px;}
...
#rptRoot .gr-tag{display:block;font-size:9.5px;font-weight:800;letter-spacing:.7px;
...
#rptRoot .dlt.up{color:#98201a;} #rptRoot .dlt.dn{color:#146b2c;} #rptRoot .dlt.fl{color:#5b6670;}
...
`;
  ...
  var S = {
    en: {
      ...
      c_sampled:"taken", c_notsampled:"not taken",
      ...
      uh_title:"Equipment Trend Report", uh_sub:"One machine · condition, trend and evidence, not a bound copy of every round",
      ...
      uh_findings_actions:"Findings & required actions", uh_open_items:"OPEN ITEMS",
      uh_not_covered:"Not yet inspected this cycle: {list}", roll_wear_cond:"Wear condition",
    ...
    ru: {
      ...
      c_sampled:"\u043e\u0442\u043e\u0431\u0440\u0430\u043d\u0430", c_notsampled:"\u043d\u0435 \u043e\u0442\u043e\u0431\u0440\u0430\u043d\u0430",
      ...
      uh_title:"Тренд состояния техники", uh_sub:"Одна машина · состояние, тренд и подтверждения, не подшивка всех осмотров",
      ...
      uh_findings_actions:"Замечания и необходимые действия", uh_open_items:"ОТКРЫТЫЕ ПУНКТЫ",
      uh_not_covered:"Ещё не осмотрено в этом цикле: {list}", roll_wear_cond:"Состояние износа",
    ...
    PHOTO[url] = new Promise(function (res) {
      ...
      img.onload = function () {
        try {
          ...
          var w = Math.min(img.naturalWidth || CMR.PHOTO_PX, CMR.PHOTO_PX);
          var h = Math.round(w * (img.naturalHeight || 1) / (img.naturalWidth || 1));
          var c = document.createElement("canvas");
          c.width = w; c.height = h;
          c.getContext("2d").drawImage(img, 0, 0, w, h);
          res(c.toDataURL("image/jpeg", CMR.PHOTO_Q));
  ...
  /* THE HISTORY-AND-TREND REPORT, TO THE TEMPLATE — a machine's condition,
     ...
     bounded to six columns), scan()/actionTable for the open work across
     every type — a wear roll-up and a graded position alike, one table, so
     the machine's worst finding cannot be present in one place and silently
     absent from another the way a separate historyFindings table once left
     it. This function is those pieces, assembled to the template's order,
     with the full detail available on request rather than printed
     regardless. */
  function unitSheets(ctx, T, recs) {
    ...
    /* A ROW FOR A DISCIPLINE NOBODY HAS WALKED YET IS EIGHT LINES OF "—", NOT
       ONE FACT. This table is the reader's first look at the machine, and on
       a fleet where most equipment carries two or three of the eight round
       types (a haul truck gets MP/FC/INSP, not GET or Lubrication), six grey
       "Not inspected" rows sat above the two that actually said anything —
       the exact "puzzle, not a story" a maintainer read off EX021's own
       report. A round type this machine has never had is named once, in one
       quiet line, instead of a row: still said, never silently dropped,
       just not given the same weight as a real reading. */
    var worst = 0;
    var coveredTypes = COND_TYPES.filter(function (ty) { return !!byType[ty]; });
    var notCovered = COND_TYPES.filter(function (ty) { return !byType[ty]; });
    var rows = coveredTypes.map(function (ty) {
      var row = typeRow(T, ty, latestByType[ty], byType[ty] && byType[ty][1]);
      if (row.rn > worst) worst = row.rn; return row.html;
    }).join("");
    var notCoveredNote = notCovered.length
      ? '<div class="muted" style="font-size:9.5px;margin-top:6px;">'
        + esc(T("uh_not_covered", { list: notCovered.map(function (ty) {
            return T.key("method_" + ty, "") ? T("method_" + ty) : ty; }).join(", ") }))
        + '</div>' : "";
    ...
    /* THE RATING / OPEN ITEMS / DECISION STRIP — the reference's own
       CONDITION RATING / SEVERITY / DECISION block from the single-round
       masthead (ratingBar, above), read at the MACHINE's level instead of
       one round's. The old strip here (UNIT / MODEL / LATEST SMU / REPORT
       DATE) said nothing the subtitle line two rows above it had not
       already said — the exact repetition a reader flagged as "a puzzle,
       not a story" beside the single-round report, which never repeats
       itself this way. OPEN ITEMS replaces SEVERITY: a whole machine has no
       one severity, but it does have a count of rows the table below is
       about to show, and that count is the one new fact this strip can
       give before the reader reaches it. */
    var wcol = worst ? GRADE_HEX[worst] : "#7b858e";
    var secs = [];
    var head = '<div class="sec">'
      ...
      + '<div class="rrate" style="margin-top:12px">'
        + '<div class="rc" style="border-left:4px solid ' + wcol + '">'
          + '<div class="rk">' + esc(T("rr_rating")) + '</div>'
          + '<div class="rv" style="color:' + (worst ? GRADE_TEXT[worst] : "inherit") + '">' + (worst || "—") + '</div></div>'
        + '<div class="rc"><div class="rk">' + esc(T("uh_open_items")) + '</div>'
          + '<div class="rv">' + (openWork.act ? openWork.act.length : 0) + '</div></div>'
        + '<div class="rc rd"><div class="rk">' + esc(T("rr_decision")) + '</div>'
          + '<div class="rv">' + T.I("dec_" + (worst || 0)) + '</div></div>'
      + '</div>'
    ...
    /* ONE TABLE, NOT TWO THAT SAY MOST OF THE SAME THING IN DIFFERENT SHAPES.
       "Consolidated actions" (actionTable, over scan()'s X.act — every open
       item, graded position and wear roll-up alike) and "Significant
       findings" (historyFindings, over `pairs` above — graded/defect
       POSITIONS only, built by its own separate walk of latestArr) were two
       independently-computed views of almost the same open-work list, and
       they disagreed at the one point that mattered: EX021's Undercarriage
       round graded 5 — Critical, "4 points at or past condemn" — had a row
       in Consolidated actions and NO row at all in Significant findings,
       because a wear roll-up carries no `.grade` and `pairs`'s own filter
       only ever asked for one. A reader comparing the two tables would have
       to notice the machine's worst finding was simply absent from the
       second one. actionTable now carries what historyFindings used to add
       (a grade/severity chip, the finding text) and this is the only table;
       historyFindings and `uh_findings` are retired below. */
    var body2 = '<div class="sec"><div class="sechd"><span class="n">01</span>'
      + '<span class="h2">' + T.I("uh_findings_actions") + '</span></div>'
      + actionTable(ctx, T, scan(recs));
  ...
  /* The consolidated open-actions table, shared by the Condition Summary and
     ...
     A GRADE COLUMN, NOT A COLOUR ALONE. Every row already carried a colour on
     its left border, and colour alone is exactly what this project's own
     grade/severity chips exist to avoid everywhere else — a stripe survives
     neither a monochrome printer nor a reader who cannot separate the reds,
     and a signed document should not ask either of a superintendent. The
     chip is the same gradeChip/sevChip pair the single-round rating strip and
     the History report's retired historyFindings table both already used, so
     a roll-up (no `.grade`, only the top-level `.sev` scan() assigned it —
     `f.it` is `{}` for a roll-up, so the grade/severity must be read off `f`,
     not `f.it`) reads its severity exactly the way a measured, ungraded point
     already does everywhere else on this sheet.

     THE FINDING ITSELF RIDES UNDER THE ACTION, NOT ONLY THE INSTRUCTION. This
     is what used to need a second table (historyFindings) that a wear
     roll-up could never appear in at all, because that table's own list was
     built by a separate walk that only ever asked for a `.grade` — see
     unitSheets' own note where this is called. A roll-up's finding is its
     worst reading, named the same way the per-round Undercarriage report's
     own "Controlling point" cell already does (`ctrl.code||ctrl.key` plus
     its percentage, unrounded) — one figure, not a duplicate rule for it. */
  function actionTable(ctx, T, X) {
    if (!X.act.length) return '<div class="verdict v-ok">' + T.S("work_none") + '</div>';
    var h = '<table class="sumtbl"><tr>'
      + '<th style="width:104px">' + T.L("c_type") + '</th>'
      + '<th style="width:136px">' + T.L("c_comp") + '</th>'
      + '<th class="c" style="width:100px">' + T.L("c_grade") + '</th>'
      + '<th>' + T.L("c_do") + '</th>'
      + '<th style="width:88px">' + T.L("ma_owner") + '</th>'
      + '<th style="width:72px">' + T.L("ma_wo") + '</th>'
      + '<th class="c" style="width:62px">' + T.L("ma_due") + '</th></tr>';
    X.act.forEach(function (f, i) {
      ...
      /* ESCAPED ONCE, AND ONLY WHAT IS TEXT. T.I() returns BUILT HTML — the
         ...
         The roll-up's own label is round-type-neutral now ("Wear condition"
         rather than a hard-coded "Undercarriage wear") — the Type column
         beside it already names Undercarriage Measurement or Dump Body
         Thickness, whichever this roll-up actually came from, and the old
         wording called a Dump Body Thickness roll-up "Undercarriage wear"
         whenever one occurred, which nothing had ever caught. */
      var comp = f.roll ? T.I("roll_wear_cond") : esc(it.name || it.key || "—");
      var grade = gnum(it.grade) ? gradeChip(it.grade) : sevChip(ctx, f.sev);
      var doit = it.action ? esc(it.action) : (f.roll ? esc(T("uc_over", { n: f.act.length })) : '<span class="muted">' + T.I("do_tbd") + '</span>');
      var findLine = f.roll
        ? '<div class="muted" style="font-size:9.5px;margin-top:2px;">' + esc(f.k) + ' ' + esc(String(f.worst)) + '% ' + esc(T("c_worn")) + '</div>'
        : (it.defect ? '<div class="muted" style="font-size:9.5px;margin-top:2px;">' + esc(it.defect) + '</div>' : "");
      ...
      h += '<tr class="' + (i % 2 ? "zebra" : "") + '">'
        ...
        + '<td>' + comp + '</td>'
        + '<td class="c">' + grade + '</td>'
        + '<td>' + doit + prioTag(it) + findLine + '</td>'
  ...
  CMR.paginate = async function (opts) {
    ...
    try{
      ...
      for(var i=0;i<els.length;i++){
        ...
        var h2c = Object.assign({scale:opts.scale||2.4, backgroundColor:"#ffffff", logging:false},
                                opts.h2c||{});
      ...
      for(var pg=1;pg<=n;pg++){
        ...
        /* 8.5 pt at #5b6670, not 7.5 pt at #7b858e: this is the only vector
           text on the page and it was the lightest thing on it. */
        doc.setFontSize(8.5); doc.setTextColor(91,102,112);
